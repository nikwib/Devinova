...
import CardDesktop from "@/app/components/ui/CardDesktop";
...
const page = () => {
  ...
  return (
    <div className="py-6 mb-7 px-3 flex flex-row gap-10">
      {/* <CardDesktop data={data.data} image={image} />
        <CardMobile data={data.data3} image={image} />
        <CardMobile data={data.data2} image={image} /> */}
      <Card data={data.data2} image={image} />
    </div>
  );
};
